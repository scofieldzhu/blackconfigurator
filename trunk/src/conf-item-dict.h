...
public:
    ...
    virtual const StringT& __stdcall GetName() = 0;
    ...
    virtual bool __stdcall GetValueAsInt(const TCHAR* key, int& out_val) = 0;
    virtual bool __stdcall GetValueAsDouble(const TCHAR* key, double& out_val) = 0;
    virtual bool __stdcall GetValueAsString(const TCHAR* key, StringT& out_val) = 0;
    virtual bool __stdcall GetConfDictValue(const TCHAR* key, ConfItemDict*& out_val) = 0;
